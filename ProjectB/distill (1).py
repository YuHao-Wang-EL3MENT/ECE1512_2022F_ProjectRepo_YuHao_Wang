...
if __name__ == '__main__':
    ...
    parser.add_argument('--save_path', type=str, default='/content/drive/MyDrive/ECE1512/ProjectB/Matching_Traj/mtt-distillation-main/results', help='path to save results')
